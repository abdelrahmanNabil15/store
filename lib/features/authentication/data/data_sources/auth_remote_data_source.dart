...
class AuthenticationRemoteDataSourceImp implements AuthenticationRemoteDataSource{
  ...
  Future<Either<Failure, LoginResponse>> login(LoginParams loginParams) async {
    final response = await _apiService.post(endPoint: Constants.loginUrl,data: loginParams, converter: (response) =>LoginResponse.fromJson(response as Map<String, dynamic>));
    return response;
  }
}