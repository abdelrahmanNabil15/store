...
mixin _$AuthEvent {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(String? username, String? password)? loginButtonPressed,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$LoginButtonPressedImpl implements _LoginButtonPressed {
  const _$LoginButtonPressedImpl({this.username, this.password});
  ...
  @override
  String toString() {
    return 'AuthEvent.loginButtonPressed(username: $username, password: $password)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loginButtonPressed(username, password);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loginButtonPressed?.call(username, password);
  }
...
abstract class _LoginButtonPressed implements AuthEvent {
  const factory _LoginButtonPressed(
      {final String? username,
      final String? password}) = _$LoginButtonPressedImpl;
